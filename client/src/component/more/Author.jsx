...
const Author = () => {
  return (
    <div className='md:p-24 font-["Poppins", sans-serif] sm:px-10 sm:py-12 h-screen'>
      <div className='flex md:flex-row justify-center items-center flex-col'>
        ...
        <div className='px-6 text-center'>
          <h2 className='py-4'><span className=' text-2xl px-3'>Hello,i'm a</span>
          <TypeAnimation
      sequence={[
