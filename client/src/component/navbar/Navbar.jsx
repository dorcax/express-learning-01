    ...
    >
      ...
      {/* hamburger on small screen  */}
        ...
        <div className="md:hidden items-center ">
          <button onClick={setToggle} className="text-3xl">{isMenuOpen?<i class="fas fa-times"></i>:<i class="fas fa-bars"></i>}</button>
        </div>
        ...
        <ul className=" pt-20">
          <li className="px-4 capitalize md:text-lg sm:text-3xl  md:py-5 sm:py-8 font-light hover:font-normal ">
            <Link to="/">home</Link>
          </li>
          <li
            className="px-4 capitalize md:text-lg sm:text-3xl md:py-5 sm:py-8 font-light hover:font-normal "
            onClick={handleClick}
          >
            categories <i className="fa-solid fa-chevron-down text-base"></i>
            {dropdown && <Dropdown />}
          ...
          <li
            className="px-4 capitalize md:text-lg md:py-5  sm:py-8 sm:text-3xl font-light hover:font-normal"
            onClick={() => setdropdown1(!dropdown1)}
          >
            blog <i className="fa-solid fa-chevron-down text-base"></i>
            {dropdown1 && <Dropdown2 />}
          ...
          <li className="px-4 capitalize md:text-lg md:py-5  sm:py-8 sm:text-3xl font-light hover:font-normal ">
            <Link to="/contact">contact</Link>
          </li>
          {/* <li> <Link to="/login">login</Link></li> */}
        ...
        {isAuthenticated ? (
          <button
            onClick={logout}
            className="border border-solid border-[#4579A0] px-4 md:py-2 sm:py-4 rounded-md capitalize md:text-md  sm:text-3xl hover:bg-[#4579A0] hover:text-[#fff] transition ease-out duration-500  "
          >
            logout
          </button>
        ) : (
